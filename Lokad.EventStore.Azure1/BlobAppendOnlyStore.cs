...
namespace Lokad.EventStore.Azure1
{
    /// <summary>
        ...
        static void CreateIfNotExists(CloudBlobContainer container, TimeSpan timeout)
        {
            ...
            while (sw.Elapsed < timeout)
            {
                ...
                catch (StorageClientException e)
                {
                    ...
                    if (
                        !(e.ErrorCode == StorageErrorCode.ResourceAlreadyExists &&
            ...
            throw new TimeoutException(string.Format("Can not create container within {0} seconds.",
